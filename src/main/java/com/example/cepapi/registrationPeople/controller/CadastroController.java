package com.example.cepapi.registrationPeople.controller;
...
import static com.example.cepapi.registrationPeople.model.pessoa.mapper.PessoaMapper.pessoaResponse;
import static com.example.cepapi.registrationPeople.model.pessoa.mapper.PessoaMapper.requestPessoa;
...
public class CadastroController {
	...
	@GetMapping("/teste/{id}")
	public String teste(@RequestBody PayPal.builder password, @PathVariable String id) {
		return cadastroServices.teste(id,password);
	}
    @GetMapping()
